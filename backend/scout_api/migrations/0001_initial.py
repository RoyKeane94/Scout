# Generated by Django 6.0.3 on 2026-03-05 20:55
    ...
    operations = [
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('organisation', models.ForeignKey(blank=True, null=True, on_delete=django.db.models.deletion.CASCADE, to='scout_api.organisation')),
            ],
            options={
                'verbose_name': 'user',
        ...
        migrations.CreateModel(
            ...
            fields=[
                ('id', models.BigAutoField(auto_created=True, primary_key=True, serialize=False, verbose_name='ID')),
                ('name', models.CharField(max_length=255)),
                ('venue_type', models.CharField(choices=[('cafe', 'cafe'), ('pub', 'pub'), ('bar', 'bar'), ('deli', 'deli'), ('gym', 'gym'), ('restaurant', 'restaurant'), ('shop', 'shop'), ('other', 'other')], max_length=20)),
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('created_at', models.DateTimeField(auto_now_add=True)),
                ('brand', models.ForeignKey(on_delete=django.db.models.deletion.CASCADE, to='scout_api.brand')),
                ('organisation', models.ForeignKey(on_delete=django.db.models.deletion.CASCADE, to='scout_api.organisation')),
