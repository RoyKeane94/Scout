...
# S3 for sighting photos (primary); Postgres photo_b64 is backup when S3 fails or is unconfigured
...
AWS_S3_CUSTOM_DOMAIN = os.environ.get('AWS_S3_CUSTOM_DOMAIN', '').strip() or None  # optional CDN
